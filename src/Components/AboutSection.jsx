    ...
    return(
        <section className="overflow-x-hidden bg-white">
            <div id="about" className="py-20 my-container flex flex-col gap-16  items-center align-center ">
                <h1 className="text-3xl md:text-4xl md:text-4xl font-bold  text-center lg text-primary">Bespoke Recruitment & Consulting for a World Beyond Ordinary</h1>
                ...
                <Cards/>
            <div id="about" className="py-20 my-container flex flex-col gap-16  items-center align-center ">
                <h1 className="text-3xl md:text-4xl md:text-4xl font-bold  text-primary">EnkaMax – Built on Trust. Driven by Excellence.</h1>
