...
export const ContactUs = () => {
    ...
    <div id="contact" className="flex flex-col my-container md:flex-row  w-full pb-8 scroll-m-80 my-40">

                <div  className=" w-full flex text-center md:text-center text-primary  py-16 flex-col gap-8 pb-4 ">
                    ...
                    <div className="flex flex-col gap-8 " >
                        ...
                        <div className="flex w-full  justify-center "><ScrollLink to="/contact" ><h1 className="  bg-tertiary hover:bg-secondary transition-colors duration-300 font-medium border-hover-secondary border-2 rounded-xl  p-2">Contact Now</h1></ScrollLink></div>
                    </div>
                </div>
                </div>
