...
export const ContactUs = () => {
    ...
    <div id="contact" className="flex flex-col my-container md:flex-row  w-full  scroll-m-80 my-40">
                ...
                <div  className=" w-full flex text-center md:text-left p-4 flex-col gap-16 pb-4 ">
                    ...
                    <div className="flex flex-col gap-16" >
                        ...
                        <div className="flex w-full justify-center md:justify-normal"><ScrollLink to="/contact" ><h1 className="  bg-white hover:bg-yellow-400 transition-colors duration-300 font-medium border-yellow-400 border-2 rounded-xl  p-2">Contact Now</h1></ScrollLink></div>
                    </div>
                </div>
                </div>
