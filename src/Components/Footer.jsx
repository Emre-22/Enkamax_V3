    ...
    return (<div className=" w-full bg-gradient-to-b from-primary to-primary-background overflow-x-hidden flex gap-10 flex-col ">
        <div className="flex justify-around md:pt-10 my-container md:flex-row flex-col">
                ...
                <div className="flex w-full  flex-col items-center py-5 justify-center gap-4 ">
                    <ScrollLink to="/about" className="text-2xl text-tertiary font-light border-b-2 border-neutral-light w-full text-center py-10 hover:text-neutral-mid">About Us</ScrollLink>
                ...
                <div className="flex w-full md:border-l-2 md:border-r-2 border-neutral-light border-t-2 md:border-t-0 border-b-2 md:border-b-0 flex-col items-center pb-4 gap-4 ">
                    <div className="flex pl-10  w-40 flex-col gap-4">
                    <ScrollLink to="/industries" className="text-2xl py-5 text-tertiary font-light  hover:text-neutral-mid underline underline-offset-8 decoration-neutral-light ">Industries</ScrollLink>
                ...
                <div className="flex w-full flex-col items-center pb-4 gap-4 ">
                    ...
                    <ScrollLink to="/services" className="text-2xl py-5 text-tertiary font-light  hover:text-neutral-mid underline underline-offset-8 decoration-neutral-light">Services</ScrollLink>
        ...
        <div className="text-tertiary pb-5 border-t-2 border-neutral-light bg-primary-background pt-5 w-full h-full text-center">
