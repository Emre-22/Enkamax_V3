            ...
            <div className=" max-w-4xl -translate-y-30   ">
                <div className="space-y-6 ">
                    ...
                    <div className="flex flex-col md:flex-row gap-5">
                        <ScrollLink to="/about" style={{ animationDelay: '.3s' }} className="border-1 border-white fade-in-left w-max rounded-3xl hover:shadow-center hover:bg-teal-800 transition-colors duration-300">
                            <div className="text-white   p-7 py-2 font-bold" >Learn more</div>
                        </ScrollLink>
                        <ScrollLink to="/contact" style={{ animationDelay: '.4s' }} className="border-1 border-teal-400 fade-in-left w-max  rounded-3xl hover:shadow-center hover:bg-teal-800 transition-colors duration-300">
