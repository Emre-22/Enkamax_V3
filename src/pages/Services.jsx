...
export const Services = () => {
  return <div className="">
    ...
    <div className="relative z-15 w-full  text-white font-medium flex flex-col   gap-4">
        <div className="relative bg-gray-100 bg-cover bg-center bg-no-repeat min-h-170  " style={{backgroundImage: `url(${ServiceBG})`}} >
            ...
            <div className="container flex flex-col gap-4">
               <div className="relative flex flex-col gap-4 container items-center pt-40 pb-10 max-w-200  z-10"> 
    ...
    <div className="">
      ...
      <div className="relative container  justify-center flex flex-col md:flex-row gap-8 max-w-90  py-20 md:p-20 ">
      {ServicesInfo.map((item,key)=>{
        const Icon = item.icon
        return <ScrollLink key={key} to="/services/realestate" className="flex flex-col hover:inner-shadow-center gap-4 border border-gray-400 p-8 lg:px-32 items-center rounded-2xl w-full min-h-50 transition-all duration-300">
      ...
      <div className="container flex flex-col gap-8 pb-30">
    ...
    <div className="relative flex flex-col container pb-16 gap-8">
