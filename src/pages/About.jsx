...
export const About = () => {
  return <div className="">
    ...
    <div className="my-container flex flex-col mb-30 gap-8"> 
        <h1 className="text-3xl font-bold text-center   text-primary">Tailored Hospitality Recruitment That Embodies Your Vision</h1>
    ...
    <div className="my-container flex flex-col mb-30 gap-8"> 
        ...
        <h1 className="text-3xl font-bold text-center   text-primary">Your Bespoke Partner in Luxury Hospitality Recruitment</h1>
    ...
    <div className="my-container  flex flex-col lg:flex-row gap-8">
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full p-20 pb-40 text-gray-800 bg-yellow-400 ">
          ...
          <div className="relative w-[75%] p-10 bottom-0 group -translate-y-1/2 text-white bg-gray-500">
            <h1 className="font-bold text-2xl pb-5">Your Discreet Talent Partner in the World of Luxury</h1>
            <ScrollLink to="/clients" className="text-lg flex gap-4 font-bold underline ">Learn More <ChevronRight className="group-hover:translate-x-15 transition-all duration-600" size={30}/></ScrollLink>
          </div>
      </div>

      <div className="w-full flex flex-col items-center">

        <div className="w-full p-20 pb-40 text-white  bg-gray-500 ">
          ...
          <div className="relative w-[75%] p-10 group -translate-y-1/2 gray-800 text-gray-800 bg-yellow-400">
      ...
      <div className=" justify-center items-center text-center my-container  w-full pt-20">
        <h1 className="text-3xl font-bold  text-primary">Driven by Excellence: Our Core Values at EnkaMax</h1>
