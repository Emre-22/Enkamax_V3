...
export const About = () => {
  return <div className="">
    ...
    <div className="my-container flex flex-col mb-30 gap-8"> 
        ...
        <h1 className="text-3xl md:text-4xl  font-bold text-center   text-primary">Your Bespoke Partner in Luxury Hospitality Recruitment</h1>
    ...
    <div className="my-container  flex flex-col lg:flex-row gap-8">
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full p-8 lg:p-20 pb-50 md:pb-40 lg:pb-50 xl:pb-40 text-tertiary bg-secondary ">
          ...
          <div className="relative w-[75%] p-5 lg:p-10 bottom-0 group -translate-y-1/2 text-tertiary bg-neutral-dark">
            <h1 className="font-bold text-2xl pb-5">Your Discreet Talent Partner in the World of Luxury</h1>
            <ScrollLink to="/services" className="text-lg flex gap-4 font-bold underline ">Learn More <ChevronRight className="group-hover:translate-x-8 transition-all duration-600" size={30}/></ScrollLink>
          </div>
      </div>

      <div className="w-full flex flex-col items-center">

        <div className="w-full p-8 lg:p-20 pb-4C0 md:pb-40 lg:pb-50 xl:pb-40 text-tertiary  bg-neutral-dark ">
          ...
          <div className="relative w-[75%] p-5 lg:p-10 group -translate-y-1/2  text-tertiary bg-secondary">
      ...
      <div className=" justify-center items-center text-left my-container  w-full ">
        <h1 className="text-3xl md:text-4xl  font-bold  text-primary">Driven by Excellence: Our Core Values at EnkaMax</h1>
        <div className="flex justify-between  w-full  flex-col 2xl:flex-row pt-24 md:gap-8 gap-16 3xl:gap-16">
            {Values.map((item,key)=>{
              const Icon = item.icon
              return <div key={key} className="flex border-2  border-neutral-mid w-full  bg-gradient-to-tr  to-neutral-light  flex-col gap-2 md:gap-5 rounded-4xl  transition-all duration-300 p-4 md:p-8 3xl:p-16">
      ...
      <div className=" justify-center items-center text-center my-container  w-full md:pt-8 pt-16 3xl:pt-16">
