...
export const RealEstate = () => {
  return <div className="">
            ...
            <div className="relative bg-gray-100 bg-cover bg-center bg-no-repeat min-h-170  " style={{backgroundImage: `url(${RealEstateBG})`}} >
                ...
                <div className="my-container flex flex-col gap-4">
                   <div className="relative flex flex-col gap-7 my-container items-center pt-40 pb-10 max-w-200  z-10"> 
                    <h1 className="text-white/90 pt-30  text-center text-2xl md:text-3xl font-bold">Tailored Global Property Solutions for Private & Investment Portfolios</h1>
    ...
    <div className="my-container flex flex-col gap-8 pt-30">
      ...
      <h3 className="text-xl text-gray-800 font-medium ">Our services include:</h3>
       <ul className="list-disc pl-6 space-y-2 text-lg text-gray-700 font-medium  ">
        ...
        <p className="text-lg text-gray-700 w-full font-medium">
