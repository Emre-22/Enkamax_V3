...
export const FamilyOffices = () => {
  return <div className="">
            ...
            <div className="relative bg-gray-100 bg-cover bg-center bg-no-repeat min-h-170  " style={{backgroundImage: `url(${FamilyOfficesBG})`}} >
                ...
                <div className="container flex flex-col gap-4">
                   <div className="relative flex flex-col gap-4 container items-center pt-40 pb-10 max-w-200  z-10"> 
                    <h1 className="text-white/90 pt-30  text-center text-2xl md:text-3xl font-bold">Family Offices With High Success</h1>
    ...
    <div className="container flex flex-col gap-8 pt-30">
      <h1 className="text-3xl text-teal-800 font-medium">Because it’s about time to redefine success.</h1>
