...
export const Privatechefs = () => {
  return <div className="">
            ...
            <div className="relative bg-gray-100 bg-cover bg-center bg-no-repeat min-h-170  " style={{backgroundImage: `url(${UHNWBG})`}} >
                ...
                <div className="my-container flex flex-col gap-4">
                   <div className="relative flex flex-col gap-4 my-container items-center pt-40 pb-10 max-w-200  z-10"> 
                    <h1 className="text-white/90 pt-30  text-center text-2xl md:text-3xl font-bold">Private Family Chef Appointments | Elite Culinary Roles in Riyadh & Across the Globe</h1>
    ...
    <div className="my-container flex flex-col gap-8 pt-30">
      ...
      <h1 className="text-3xl text-teal-800 font-medium">Why Private Chef Roles Are in High Demand</h1>
        <p className="text-lg text-gray-700 font-medium">
      ...
      <h1 className="text-3xl text-teal-800 font-medium">Benefits of a Private Chef Career</h1>
    <div>
    ...
    <div className="relative my-container mt-20 py-20 bg-cover bg-center bg-no-repeat gap-8 flex flex-col w-full " style={{backgroundImage: `url(${PrivateChef2})`}}>
      ...
      <h1 className="text-3xl text-white font-bold z-20">Your Trusted Partner in Private Chef Recruitment</h1>
      <h1 className="text-lg text-white font-medium z-20">At EnkaMax, we specialise in placing exceptional culinary professionals in the most exclusive private households and residences around the world. Whether for daily gourmet dining, high-profile entertaining, or bespoke health-focused cuisine, we match skilled private chefs with discerning families and individuals who value excellence, discretion, and creativity.<br/>
