...
export const Privatechefs = () => {
  return <div className="">
    ...
    <div className="my-container flex flex-col gap-8 pt-30">
      ...
      <h1 className="text-3xl  md:text-4xl text-center text-primary   font-bold pt-30">Why Private Chef Roles Are in High Demand</h1>
        <p className="text-lg text-neutral-dark font-medium">
    ...
    <div className="my-container  mt-20 py-20 gap-8 grid xl:grid-cols-2 grid-cols-1  w-full ">
        <div>
          ...
          <p className="text-lg text-neutral-dark pt-10 font-medium">
            ...
            Submit Your CV and your Food Presentation – Showcase your culinary credentials, specialties, and experience in private service or luxury hospitality.<br/><br/>
